...
Данный пункт необходимо выполнить для спены стандартного IP адреса оборудования на IP адрес сети предприятия. При смене IP адреса можно потерять доступ к оборудованию, что приведет к сбросу конфигурации и повторной настройке.
